            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div>
                ...
                <div className="space-y-6">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <div key={i} className="bg-happi-darker rounded-xl p-6">
                      <h3 className="font-bold text-white mb-2">{t(`cxItems.${i}.title`)}</h3>
                      <p className="text-happi-muted text-sm">{t(`cxItems.${i}.description`)}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  {Array.from({ length: 5 }).map((_, i) => (
                    <div key={i} className="bg-happi-darker rounded-xl p-6">
                      <h3 className="font-bold text-white mb-2">{t(`supplyItems.${i}.title`)}</h3>
                      <p className="text-happi-muted text-sm">{t(`supplyItems.${i}.description`)}</p>
                    </div>
                  ))}
                </div>
              </div>
