...
export default function SecretaryCTA({ fr, size = 'lg' }: { fr: boolean; size?: 'sm' | 'lg' }) {
  ...
  const base = 'btn-shimmer inline-flex items-center gap-2 rounded-xl font-bold text-white bg-happi-blue-strong hover:bg-happi-blue-strong/90 transition-all shadow-xl shadow-happi-blue/20';
