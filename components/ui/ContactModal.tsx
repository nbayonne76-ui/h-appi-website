...
const copy = {
  fr: {
    ...
    errorText: 'Une erreur est survenue. Contactez-nous directement : contact@happi-bot.com',
    close: 'Fermer',
  ...
  en: {
    ...
    errorText: 'Something went wrong. Reach us directly at: contact@happi-bot.com',
    close: 'Close',
