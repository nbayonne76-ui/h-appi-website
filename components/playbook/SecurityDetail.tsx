...
export default async function SecurityDetail({ locale }: { locale: string }) {
    ...
    <>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-happi-dark">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-bold text-white">{t('hostingTitle')}</h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-happi-surface rounded-2xl p-6 border border-happi-border">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="text-lg font-bold text-white">Scaleway</h4>
                  <p className="text-sm text-happi-green">🇫🇷 France</p>
                </div>
            ...
            <div className="bg-happi-surface rounded-2xl p-6 border border-happi-border">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h4 className="text-lg font-bold text-white">Hetzner</h4>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-happi-darker">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-bold text-white">{t('rgpdTitle')}</h3>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-happi-dark">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h3 className="text-2xl font-bold text-white">{t('certsTitle')}</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-happi-border">
                  <th className="text-left py-3 pr-4 text-happi-muted font-medium">Certification</th>
                  <th className="text-left py-3 pr-4 text-happi-muted font-medium">Description</th>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-happi-darker">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h3 className="text-2xl font-bold text-white">{t('securityTitle')}</h3>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-happi-dark">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-2xl font-bold text-white">{t('sovereigntyTitle')}</h3>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-happi-darker">
        <div className="max-w-3xl mx-auto">
          <h3 className="text-2xl font-bold text-white mb-8 text-center">{t('faqTitle')}</h3>
          <div className="space-y-4">
            {faqItems.map((item, i) => (
              <div key={i} className="bg-happi-surface rounded-xl p-6 border border-happi-border">
                <h4 className="font-semibold text-white mb-2">{item.q[lang]}</h4>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-happi-dark">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-2xl font-bold text-white mb-2 text-center">{t('summaryTitle')}</h3>
